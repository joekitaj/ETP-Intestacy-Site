    ...
    for (var r in this.config.tags) {
      ...
      null != a.subTreeConfig &&
        (this._layoutConfigs[r] = {
          ...
          collapse:
            null != a.subTreeConfig.collapse ? a.subTreeConfig.collapse : this.config.collapse,
...
;(FamilyTree._defaultConfig = function (e) {
  ...
  (FamilyTree.prototype.canUpdateLink = function (e, t) {
    ...
    return (
      !(
        i &&
        r &&
        (i.isPartner || (i.hasPartners && r.isAssistant) || (i.hasAssistants && r.isPartner))
      ) && !this.isChild(e, t)
    )
  }),
    ...
    ;(r || (r = ''), e.getListenerList || (e.getListenerList = {}), e.getListenerList[t + r]) ||
      ...
      e.addEventListener
        ...
        : e.attachEvent('on' + t, function () {
            ...
            return (
              !1 === t && ((window.event.returnValue = !1), (window.event.cancelBubble = !0)), t
            )
          }),
  ...
  (FamilyTree.editUI.prototype._focusElement = function (e) {
    ...
    FamilyTree.isNEU(this.obj.config.editForm.focusBinding)
      ...
      t &&
        (t.value && t.value.length && t.setSelectionRange(t.value.length, t.value.length),
        t.focus())
  }),
  ...
  (FamilyTree._getFistImgField = function (e) {
    if (e.nodeBinding)
      for (var t in e.nodeBinding) if (-1 != t.indexOf('img')) return e.nodeBinding[t]
    return !1
  }),
  (FamilyTree._fieldIsImg = function (e, t) {
    if (e.nodeBinding)
      for (var i in e.nodeBinding) if (e.nodeBinding[i] == t) return FamilyTree._lblIsImg(e, i)
    return !1
  }),
  ...
  (FamilyTree.wrapText = function (e, t) {
    ...
    if (
      (f.length > 1 &&
        ((a = parseInt(m.split('-')[1])), f.length > 2 && 'ellipsis' == f[2] && (n = !0)),
      !c)
    )
      return FamilyTree._escapeHtml(e)
  ...
  (FamilyTree._xml2json = function (e) {
    for (
      var t = new DOMParser().parseFromString(e, 'text/xml').getElementsByTagName('node'),
        i = [],
        r = 0;
      r < t.length;
      r++
  ...
  (FamilyTree._json2csv = function (e) {
    for (
      ...
      for (var n in e[a])
        FamilyTree._arrayContains(t, n) || (t.push(n), (r += n + FamilyTree.CSV_DELIMITER))
  ...
  (FamilyTree.collapsedChildrenTotalCount = function (e, t, i) {
    for (var r = 0, a = 0; a < t.childrenIds.length; a++) {
      ...
      n &&
        ((i || !0 === n.collapsed) && r++, (r += FamilyTree.collapsedChildrenTotalCount(e, n, !0)))
    }
    return r
  }),
  ...
  (FamilyTree._getViewBox = function (e) {
    var t = null
    return e
      ? ((t = (t = '[' + (t = e.getAttribute('viewBox')) + ']').replace(/\ /g, ',')),
        (t = JSON.parse(t)))
      : null
  }),
  ...
  (FamilyTree.prototype._globalClickHandler = function (e, t) {
    ...
    for (var o = t.target; o != e; ) {
      ...
      if (o.hasAttribute(FamilyTree.attr.control_node_circle_menu_name))
        return (
          t.stopPropagation(), t.preventDefault(), void this._nodeCircleMenuItemClickHandler(o, t)
        )
  ...
  (FamilyTree.prototype._nodeCircleNodeMenuItemMouseDownHandler = function (e, t, i) {
    ...
    if (n.draggable) {
      ...
      f.setAttribute('transform', 'matrix(1,0,0,1,' + (y + T.x) + ',' + (g + T.y) + ')'),
        (f.style.opacity = 0.7)
      var b = function (e, t) {
          if (null != e) {
  ...
  (FamilyTree.prototype._nodeClickHandler = function (e, t) {
    ...
    if (i && i._dragEventFired) i._dragEventFired = !1
      ...
      if (!1 === FamilyTree.events.publish('click', [this, { node: this.getNode(e), event: t }]))
        return !1
  ...
  (FamilyTree.prototype._mouseDownHandler = function (e, t, i) {
    ...
    t.touches &&
      t.touches.length > 1 &&
      ((s.type = 'pinch'),
      (s.dist = Math.sqrt((l.x - o.x) * (l.x - o.x) + (l.y - o.y) * (l.y - o.y)))),
    ...
    null == l && (l = FamilyTree.local),
      l._setPositions(
        ...
        function (t) {
          ...
          for (
            var o = { minX: null, minY: null, maxX: null, maxY: null }, s = {}, d = 0;
            d < n.length;
            d++
          )
  ...
  (FamilyTree.manager._iterate = function (e, t, i, r, a, n, l, o, s, d, c, m) {
    ...
    t.stChildren.length &&
      (e.stContainerNodes || (e.stContainerNodes = []), e.stContainerNodes.push(t))
    for (var T = 0; T < t.stChildren.length; T++) {
      ...
      a.push(t.stChildren[T].id),
        FamilyTree.manager._iterate(e, t.stChildren[T], i, 0, a, n, l, o, b, d, c, m)
    }
    r++
  ...
  (FamilyTree.manager._createNodes = function (e) {
    ...
    if (r == FamilyTree.action.init && t.expand && t.expand.nodes && null == l)
      for (c = 0; c < t.expand.nodes.length; c++) {
        ...
        for (
          !0 === t.expand.allChildren && FamilyTree.manager._addExpandedNodeIdsIterate(g, o, y);
          g;

        )
          y.push(g.id),
            null == g.pid && null != g.stpid ? ((g = o[g.stpid]).min = !1) : (g = o[g.pid])
      }
    else if (
  ...
  (FamilyTree.prototype._slinks = function (e, t) {
    ...
    function n(t, n, l) {
      ...
      if (t.sl == n.sl)
        ...
        switch (
          ((h = FamilyTree.t(d.templateName, d.min, r)), s.splice(s.length - 1, 1), p.orientation)
        ) {
          case FamilyTree.orientation.top:
          case FamilyTree.orientation.top_left:
            s.push([d.x + d.w / 2 + h.expandCollapseSize, s[s.length - 1][1]]),
  ...
  (FamilyTree.prototype.magnify = function (e, t, i, r, a) {
    ...
    if (n || l) {
      ...
      ;(FamilyTree._magnify[e] = { timer: p, transformStart: s, nodeElement: l, front: i }),
        a && a(l)
    }
  }),
    ...
    return (
        ...
        (n = `<a href="#" data-input-btn="" class="bft-link bft-link-bft-button">${t.btn}</a>`),
      {
        html: `<div class="bft-form-field" style="min-width: ${i};">\n                    <div class="bft-input" data-bft-input="" ${
          ...
          a.readOnlyAttribute
        } data-binding="${FamilyTree._escapeDoubleQuotes(a.binding)}" maxlength="256" id="${
          a.id
        }" name="${a.id}" type="text" value="${FamilyTree._escapeDoubleQuotes(
          a.value
        )}" autocomplete="off">\n                        ${n}\n                    </div>\n                </div>`,
        id: a.id,
        value: a.value
  ...
  (FamilyTree.input.initWithTimeout = function () {
    FamilyTree.input._timeout &&
      (clearTimeout(FamilyTree.input._timeout), (FamilyTree.input._timeout = null)),
      ...
      ;(c.innerHTML = `<div>${m}</div>`),
        c.addEventListener('click', function (e) {
          if (
            ...
            if ((n && n.parentNode.removeChild(n), e.target.hasAttribute('data-filter-close')))
              return
  ...
  (FamilyTree.remote._setPositions = function (e, t, i, r) {
    for (
      var a = [], n = [], l = FamilyTree.remote._toReqLayoutConfigsDTO(t), o = 0;
      o < e.length;
      o++
    )
